<template>
  <div class="page-shell page-shell--wide">
    <Card class="w-full form-card">
      <template #title>Ranking de players</template>
      <template #content>
        <div class="app-highlight app-highlight--accent mb-4">
          <div>
            <span class="app-highlight-label">Ranking competitivo</span>
            <strong class="app-highlight-title">Compare desempenho por modo e formato</strong>
          </div>
          <p class="app-highlight-copy">Filtre os rankings para enxergar com mais clareza quem esta performando melhor em cada ambiente do sistema.</p>
        </div>
...
import { getPlayerRankings } from '@/services/rankings'
